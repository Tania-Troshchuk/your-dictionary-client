...
import { useDeleteTestMutation, useGetTestsQuery } from "../redux/services/testAPI"
...
export const Results = () => {
  ...
  const handleDeleteResult = useCallback(async (_id: string) => {
      ...
      {data?.length
        ...
        : (
          <div className="info-text">
            To view your results, you must successfully complete the test.
            Please <Link to={routes.test}>click here</Link> to go to the Test page.
          </div>
        )}
    </div>
  )
